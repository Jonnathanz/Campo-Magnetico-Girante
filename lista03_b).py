...
def main():
    ...
    plt.title('Campo girante com alimentação trifásica simétrica')

    def update(t):
        t *= 0.05                                                   # Passo de tempo t para 0.05, variando de 0 até 6.25 conforme os frames
    ...
    anim.save('Lista_03_b.gif', dpi=80, writer='imagemagick')
    plt.show()
